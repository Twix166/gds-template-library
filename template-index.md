...
| Issue register | Cross-cutting | Delivery management | Track active delivery, design, technical and governance issues. | Use agile ways of working | placeholder |
| Decision log | Cross-cutting | Governance | Record key decisions, evidence and consequences. | Have a multidisciplinary team | placeholder |
| Dependency register | Cross-cutting | Delivery management | Track internal and external dependencies affecting delivery. | Provide a joined-up experience | placeholder |
